...
var UnitTests;
(function (UnitTests) {
    var HttpDownloadProviderTest = (function () {
        function HttpDownloadProviderTest() {
        }
        HttpDownloadProviderTest.prototype.runTest = function (resultwindow) {
            config.httpDownloadMaxSimultaneousDownloads = 3;
            var result = "";
            var result2 = "";
            var resultL = "";
            // Set up download object
            var item1 = new System.Providers.HttpDownloadItem("1", "UnitTests.html", function (data) { result += "1"; result2 += "1"; }, function (message) { resultwindow.append("<div style='color:red'>HttpDownloadProvider: Error: " + message + "</div>\r\n"); }, function () { });
            var item2 = new System.Providers.HttpDownloadItem("2", "UnitTests.html", function (data) { result += "2"; result2 += "2"; }, function (message) { resultwindow.append("<div style='color:red'>HttpDownloadProvider: Error: " + message + "</div>\r\n"); }, function () { });
            var item3 = new System.Providers.HttpDownloadItem("3", "UnitTests.html", function (data) { result += "3"; result2 += "3"; }, function (message) { resultwindow.append("<div style='color:red'>HttpDownloadProvider: Error: " + message + "</div>\r\n"); }, function () { });
            var itemA = new System.Providers.HttpDownloadItem("A", "UnitTests.html", function (data) { result2 += "A"; resultL += "A"; }, function (message) { resultwindow.append("<div style='color:red'>HttpDownloadProvider: Error: " + message + "</div>\r\n"); }, function () { });
            var itemB = new System.Providers.HttpDownloadItem("B", "UnitTests.html", function (data) { result2 += "B"; resultL += "B"; }, function (message) { resultwindow.append("<div style='color:red'>HttpDownloadProvider: Error: " + message + "</div>\r\n"); }, function () { });
            var itemC = new System.Providers.HttpDownloadItem("C", "UnitTests.html", function (data) { result2 += "C"; resultL += "C"; }, function (message) { resultwindow.append("<div style='color:red'>HttpDownloadProvider: Error: " + message + "</div>\r\n"); }, function () { });
            var itemEnd = new System.Providers.HttpDownloadItem("E1", "UnitTests.html", function (data) {
                setTimeout(function () {
            ...
            }, function (message) { resultwindow.append("<div style='color:red'>HttpDownloadProvider: Error: " + message + "</div>\r\n"); }, function () { });
            var itemEndL = new System.Providers.HttpDownloadItem("EL", "UnitTests.html", function (data) {
                setTimeout(function () {
                    var correct = "ABBBCC";
                    if (resultL == correct) {
        ...
        return HttpDownloadProviderTest;
    })();
    UnitTests.HttpDownloadProviderTest = HttpDownloadProviderTest;
})(UnitTests || (UnitTests = {}));
