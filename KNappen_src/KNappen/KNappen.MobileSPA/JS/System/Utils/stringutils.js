    ...
    (function (Util) {
        var StringUtils = (function () {
            ...
            /**
              ...
              */
            StringUtils.prototype.highlightWord = function (text, words, color, onlyFromBeginning) {
                words = $.trim(words);
                if (!text || !words || !color)
                    return text;
                ...
                var keys = words.split(' ').sort(function (a, b) { return (a.length > b.length) ? -1 : (a.length == b.length) ? 0 : 1; });
                for (var ki in keys) {
            ...
            /**
              ...
              */
            StringUtils.prototype.toFieldBold = function (key) {
                var values = [];
            ...
            /**
              ...
              * @returns {string} The formated field
              */
            StringUtils.prototype.toField = function (key, value) {
                if (value == null || value == "") {
                    return "";
                }
                if (key == null) {
            ...
            /**
              ...
              * @returns {string} The formated field
              */
            StringUtils.prototype.toFieldFromCode = function (key, code) {
                var value = null;
                if (code == null || code == "") {
                    return "";
                }
                if (key == "Bostatus") {
                    switch (code) {
                        case "b":
                            value = "Bosatt p\u00E5 stedet";
                            break;
                        case "f":
                            value = "Midlertidig frav\u00E6rende";
                            break;
                        case "mt":
                            value = "Midlertidig tilstede";
                            break;
                        default:
                            value = code;
                            break;
                    ...
                    switch (code) {
                        ...
                        case "l":
                            ...
                            break;
                        case "lf":
                            value = "Lappisk, fastboende";
                            break;
                        case "ln":
                            value = "Lappisk, nomadiserende";
                            break;
                        case "f":
                            value = "Finsk(kvensk)";
                            break;
                    ...
                    switch (code) {
                        ...
                        case "d":
                            ...
                            break;
                        case "tj":
                            value = "Tjenestetyende";
                            break;
                        case "fl":
                            value = "Losjerende, h\u00F8rende til familien";
                            break;
                        case "b":
                            value = "Bes\u00F8kende";
                            break;
                        case "el":
                            value = "Enslig losjerende";
                            break;
                        default:
                            value = code;
                            break;
